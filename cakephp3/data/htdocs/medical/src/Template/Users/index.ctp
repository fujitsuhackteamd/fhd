                    ...
                    <div class="d-block my-3">
                        ...
                        <div class="row ml-2">
                            <div class="custom-control custom-radio">
                                <input id="online" name="online_or_visit" type="radio" value="オンライン" class="custom-control-input online_or_visit" onclick="form_switch()" required>
                                <label class="custom-control-label" for="online">オンライン</label>
                            </div>
                            <div class="custom-control custom-radio mr-3">
                                <input id="visit" name="online_or_visit" type="radio" value="来院" class="custom-control-input online_or_visit" onclick="form_switch()" required>
                                <label class="custom-control-label" for="visit">来院</label>
                            </div>
                        </div>
                    </div>
                    <div class="d-block my-3" id="checklist">
                        <label for="address">優先項目</label>
                        <div class="row ml-2">
                            <div class="custom-control custom-radio mr-3">
                                <input id="long" name="choice" type="radio" value="距離" class="custom-control-input"  required>
                                <label class="custom-control-label" for="long">距離</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input id="con" name="choice" type="radio" value="混雑度" class="custom-control-input" required>
                                <label class="custom-control-label" for="con">混雑度</label>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
